...
router.get('/product/products/:storeId', productController.getStoreProducts);
...
router.post('/product/upload-image', upload.single('file'), authMiddleware, sellerMiddleware, (req, res) => {
    if (!req.file) {
